...
public class GameHandler : MonoBehaviour {
	...
	void Start () {
        ...
        for(int i = 0; i < 2; i++)
        {
            float[] defaultStats = { 1, 1, 0, 0, 0, 1, 1 };
        ...
        equippedSkills[3] = SkillAssigner.SkillNames.HEAL;
        ...
        equippedSkills[10] = SkillAssigner.SkillNames.REALLOCATE;
        equippedSkills[11] = SkillAssigner.SkillNames.FIREBALL;
        equippedSkills[12] = SkillAssigner.SkillNames.FIREBALL;
